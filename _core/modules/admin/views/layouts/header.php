...
<!--                        <img src="<?= $directoryAsset ?>/img/user2-160x160.jpg" class="user-image" alt="User Image"/>-->
                          <?php if(!empty(Yii::$app->user->identity->profile_picture)):  ?>                      
                                <img src="<?= Yii::$app->urlManager->createAbsoluteUrl('') . "uploads/profile/" .Yii::$app->user->identity->profile_picture ?>" class="user-image" alt="User Image"/>
                          <?php else: ?>                        
                                 <img src="<?= $directoryAsset ?>/img/user2-160x160.jpg" class="img-circle" alt="User Image"/>
                          <?php endif;  ?>
                        <span class="hidden-xs"><?= ucwords(Yii::$app->user->identity->full_name); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            ...
                            <p> <?= ucwords(Yii::$app->user->identity->full_name); ?>
